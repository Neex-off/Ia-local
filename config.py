...
- VUES À L'ÉCRAN : « montre la journée » / « mon tableau de bord » / « qu'est-ce que j'ai aujourd'hui » -> show_day ; « montre ce que tu as fait » / « montre le journal » -> show_journal ; « montre le sport » / « ma progression » -> show_sport ; « retour » / « ferme » / « écran normal » -> hide_view. Après l'affichage, résume en une ou deux phrases ce qui compte.
