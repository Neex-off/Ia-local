...
| La page reste sur « Modèle de langage » | Ollama n'a pas répondu (il démarre avec le système) : Jarvis l'attend 90 s et le lance si besoin ; passé ce délai, un message rouge explique quoi faire. Deux Jarvis lancés en même temps : la deuxième instance s'arrête d'elle-même |
